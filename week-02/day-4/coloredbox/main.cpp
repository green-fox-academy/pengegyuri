...
void draw()
{
    ...
    SDL_RenderDrawLine(gRenderer, SCREEN_WIDTH / 2 - 25, SCREEN_HEIGHT / 2 - 25, SCREEN_WIDTH / 2 - 25, SCREEN_HEIGHT /2 + 25);
    SDL_SetRenderDrawColor(gRenderer, 0x00, 0xFF, 0x00, 0xFF);
    SDL_RenderDrawLine(gRenderer, SCREEN_WIDTH / 2 - 25, SCREEN_HEIGHT / 2 - 25, SCREEN_WIDTH / 2 + 25, SCREEN_HEIGHT /2 - 25);
    SDL_SetRenderDrawColor(gRenderer, 0x00, 0x00, 0xFF, 0xFF);
    SDL_RenderDrawLine(gRenderer, SCREEN_WIDTH / 2 - 25, SCREEN_HEIGHT / 2 + 25, SCREEN_WIDTH / 2 + 25, SCREEN_HEIGHT /2 + 25);
    SDL_SetRenderDrawColor(gRenderer, 0x8F, 0x8F, 0x00, 0xFF);
    SDL_RenderDrawLine(gRenderer, SCREEN_WIDTH / 2 + 25, SCREEN_HEIGHT / 2 + 25, SCREEN_WIDTH / 2 + 25, SCREEN_HEIGHT /2 - 25);
